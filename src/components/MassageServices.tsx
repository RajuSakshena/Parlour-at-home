...
// Calculate dynamic price range and offer count
const allServices = [...bodyPolishServices, ...massageServices];
...
export default function MassageServices() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "Massage Services at Home",
        "item": "https://www.parlouratdoorstep.com/services/massage"
      }
    ]
  };
  ...
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Massage & Body Polish Services",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Professional massage and body polish services at home including Full Body Massage, Rejuvenating Massage, Body Scrub, Body Polish, and more. Certified therapists bring spa-quality treatments to your doorstep.",
    "offers": {
      "@type": "AggregateOffer",
      "priceCurrency": "INR",
      "lowPrice": minPrice,
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Massage & Body Polish Services",
      "itemListElement": [
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Body Polish" } },
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What types of massage services do you offer at home?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We offer Full Body Massage, Rejuvenating Massage, Healthy Head Massage, Shoulder & Back Massage, Foot Massage, and Arms Massage. All treatments are performed by certified professionals."
        }
      },
      {
        "@type": "Question",
        "name": "What is the difference between body scrub and body polish?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Body scrub focuses on exfoliation to remove dead skin cells, while body polish is a 4-step treatment including oil massage, scrub, body pack, and moisturizer for deeper skin nourishment and regeneration."
        }
      },
      {
        "@type": "Question",
        "name": "What is the price range for massage services?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Our massage and body polish services start from ₹${minPrice} and go up to ₹${maxPrice}, with discounts ranging from 20% to 50% off.`
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "How do I book a massage service?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Are the products used safe for all skin types?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, we use high-quality, monodose products suitable for all skin types. Please inform our therapist of any allergies or sensitivities before the service."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Massage & Body Polish Services at Home in Delhi NCR | Parlour at Doorstep</title>
        <meta name="description" content="Book professional massage and body polish services at home in Delhi, Noida, Gurugram, Ghaziabad and Faridabad. Full Body Massage, Rejuvenating Massage, Body Scrub & Polish by certified therapists." />
        <link rel="canonical" href="https://www.parlouratdoorstep.com/services/massage" />
        <meta property="og:title" content="Massage & Body Polish Services at Home in Delhi NCR | Parlour at Doorstep" />
        <meta property="og:description" content="Book professional massage and body polish services at home in Delhi, Noida, Gurugram, Ghaziabad and Faridabad. Full Body Massage, Rejuvenating Massage, Body Scrub & Polish by certified therapists." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.parlouratdoorstep.com/services/massage" />
        <meta property="og:site_name" content="Parlour at Doorstep" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Massage & Body Polish Services at Home in Delhi NCR | Parlour at Doorstep" />
        <meta name="twitter:description" content="Book professional massage and body polish services at home in Delhi, Noida, Gurugram, Ghaziabad and Faridabad. Full Body Massage, Rejuvenating Massage, Body Scrub & Polish by certified therapists." />
